...
function Moroi() {
  ...
  const details = [
    "Maudit un joueur lors d'une réponse à la spirit box, micro parabolique ou enregistreur sonore",
    ...
    "L'encens le désoriente pendant 7s (au lieu de 5s) durant une chasse",
